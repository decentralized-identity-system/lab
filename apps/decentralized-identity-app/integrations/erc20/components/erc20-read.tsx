...
interface ERC20Image extends ERC20Props {
  chainId?: number
  fallbackImg?: string
}

export function ERC20Image({ address, fallbackImg, ...props }: ERC20Image) {
  const [imgSrc, setImgSrc] = useState(`https://raw.githubusercontent.com/Uniswap/assets/master/blockchains/ethereum/assets/${address}/logo.png`)
  ...
  return (
    <img
      ...
      src={imgSrc}
      onError={() => setImgSrc(fallbackImg || `/icons/token-default.png`)}
      {...props}
    />
  )
}
